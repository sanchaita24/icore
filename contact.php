        ...
        <div id="carouselExampleInterval" class="carousel slide mt-5" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="https://media.istockphoto.com/id/1461631609/photo/happy-smiling-students-looking-at-camera-while-preparing-for-exams-by-reading-books-at.jpg?s=1024x1024&w=is&k=20&c=LzoP2Jl6xR8ZUOtbCpk0LByrup_mMqrY6KXZ8NV0Fyk="
    ...
    <section class="forth">
        <div class="col-md-6">
            <h3 class="text-center mt-3"><strong>Take the next step toward your personal and professional goals with
                    Lcore.</strong></h3>
            <p class="brand_text text-center mx-5">Train teams with industry-leading experts and universities, enhanced by AI
                tools and
